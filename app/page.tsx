...
export default function Home() {
  return (
    <div className="flex flex-col flex-1 items-center bg-zinc-50 font-sans dark:bg-black">
      <main className="flex w-full max-w-4xl flex-col items-center gap-6 px-6 py-12">
        ...
        <p className="text-zinc-500 dark:text-zinc-400 text-center max-w-xl">
          ...
          provincias, y en una provincia para ver sus distritos. Cada zona se
          colorea según el total de denuncias policiales registradas (2018–2026).
        </p>
        <MapaPeru />
      </main>
    </div>
